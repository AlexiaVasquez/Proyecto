//----------VALIDACION FORMULARIO INTERNET-------------
/*
...
document.addEventListener("DOMContentLoaded", 
    function()
 {
  document.getElementById("Formulario_Internet").addEventListener('submit', validarFormularioInternet); 
  /*
  addEventListener('submit', validarFormularioCrearCuenta):se activa cada vez que alguien intenta
   enviar el formulario.
  */
});
function validarFormularioInternet(evento)
{
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document
        .getElementById("Formulario_Internet")
        .addEventListener("submit", validarFormularioInternet);

    // 2. Restricción del campo NPE: solo números 0–9
    var  NumeroNPE_EDig= document.getElementById("NumeroNPE");
